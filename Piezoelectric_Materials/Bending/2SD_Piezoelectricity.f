...
C     
      ...
      DOUBLE PRECISION, DIMENSION(4,2) :: Bphi_SD_T
      DOUBLE PRECISION, DIMENSION(8,3) :: Bu_SD_T
      DOUBLE PRECISION, DIMENSION(8):: MECH_FORCE
      DOUBLE PRECISION, DIMENSION(4) :: ELE_FORCE
...
C   ELECTRICAL FIELD CALCULATION 
      ...
      Bphi_SD_T = TRANSPOSE_MATRIX(Bphi_SD, Bphi_SD_T,2,4) 
      DO I = 1,2
        DO J = 1,4 
...
C   ELE. FIELD OF SD1 
      DO I = 1,2 
        DO J = 1,4 
            ELE_FIELD_SD(I,1) = 0.5*Bphi_1SD(I,J)*U_ELE(J)
        END DO
      END DO
C   ELE. FIELD OF SD2 c
      DO K = 1,2 
        DO M = 1,4 
            ELE_FIELD_SD(I,1) = 0.5*Bphi_2SD(K,M)*U_ELE(M)
        END DO
      END DO
      ELE_FIELD_SD = -ELE_FIELD_SD
...
C   S-VARIABLES 
      ...
      SVARS(11) = AREA_CELL(1)
      SVARS(12) = AREA_CELL(2)
C --------------------------------------------------------------------
      DO I = 1,NDOFEL
        DO J = 1,NDOFEL
